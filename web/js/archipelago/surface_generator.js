...
function generateTerrainMap(mapDimension, unitSize, roughness, seed) {
    ...
    function startDisplacement(map, mapDimension){
        ...
        // top left
        map[0][0] = random.realZeroToOneInclusive();
        topLeft = map[0][0];

        // bottom left
        map[0][mapDimension] = random.realZeroToOneInclusive();
        bottomLeft = map[0][mapDimension];

        // top right
        map[mapDimension][0] = random.realZeroToOneInclusive();
        topRight = map[mapDimension][0];

        // bottom right
        map[mapDimension][mapDimension] = random.realZeroToOneInclusive();
    ...
    function midpointDisplacment(dimension){
        var newDimension = Math.floor(dimension / 2),
            topRight = 0,
            topLeft = 0,
            bottomLeft = 0,
            bottomRight = 0,
    ...
    function displace(num){
        ...
        return (random.realZeroToOneInclusive() - 0.5) * max;
    }
